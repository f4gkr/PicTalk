...
static void LIBUSB_CALL _libusb_callback (struct libusb_transfer *xfer) {
    ...
    if (xfer->status == LIBUSB_TRANSFER_COMPLETED) {
        ...
        switch( xfer->status ) {
            ...
            case LIBUSB_TRANSFER_TIMED_OUT : fprintf( stderr,"Transfer timed out.\n"); break ;
            case LIBUSB_TRANSFER_CANCELLED : fprintf( stderr,"Transfer was cancelled.\n"); break ;
            case LIBUSB_TRANSFER_STALL : fprintf( stderr,"Transfer was LIBUSB_TRANSFER_STALL.\n"); break ;
            case LIBUSB_TRANSFER_NO_DEVICE : fprintf( stderr,"Device was disconnected.\n"); break ;
            case LIBUSB_TRANSFER_OVERFLOW : fprintf( stderr,"Device sent more data than requested\n"); break ;
        default:
...
int mirisdr_read_async (mirisdr_dev_t *p, mirisdr_read_async_cb_t cb, void *ctx,
