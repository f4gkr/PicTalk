...
public:
    ...
    void updateMinMax( qint64 Minf, qint64 Maxf ) ;
    ...
    void resetToFrequency( qint64 freq ) ;
...
private slots:
    void performNewFrequencyBroadcast();
